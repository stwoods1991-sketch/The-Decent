...
export const ITEMS: Item[] = [
 // Weapons — attack
 {id:'blade',name:'Rusty Waiver Blade',slot:'Weapon',rarity:'Common',stat:'attack',value:3},
 {id:'stick',name:'Splintered Hockey Stick',slot:'Weapon',rarity:'Common',stat:'attack',value:3},
 {id:'skate',name:'Sharpened Skate Blade',slot:'Weapon',rarity:'Uncommon',stat:'attack',value:5},
 ...
 {id:'gavel',name:'Commissioner’s Gavel',slot:'Weapon',rarity:'Legendary',stat:'attack',value:16},
 ...
 {id:'visor',name:'Tilt-Proof Visor',slot:'Helmet',rarity:'Epic',stat:'maxHp',value:35},
 ...
 {id:'mask',name:'Cursed Goalie Mask',slot:'Helmet',rarity:'Cursed',stat:'defense',value:9,curse:'Enemy attack +8%'},
 // Armor — defense / maxHp
 ...
 {id:'cloak',name:'Injury Report Cloak',slot:'Armor',rarity:'Rare',stat:'defense',value:7},
 {id:'pads',name:'Overpriced Goalie Pads',slot:'Armor',rarity:'Rare',stat:'maxHp',value:28},
 ...
 {id:'sweater',name:'Cursed Lucky Sweater',slot:'Armor',rarity:'Cursed',stat:'maxHp',value:60,curse:'Enemy attack +8%'},
 // Boots — speed
 ...
 {id:'cheese',name:'Golden Cheese Charm',slot:'Trinket',rarity:'Rare',stat:'maxHp',value:24},
 {id:'secondline',name:'Second-Line Charm',slot:'Trinket',rarity:'Rare',stat:'attack',value:8},
 {id:'rabbit',name:'Rabbit’s Foot (Amputated)',slot:'Trinket',rarity:'Epic',stat:'speed',value:0.18},
 ...
 {id:'coin',name:'Cursed Coin Flip',slot:'Trinket',rarity:'Cursed',stat:'attack',value:12,curse:'Enemy attack +8%'},
 // Relics — high impact
 {id:'trophy',name:'Deflated Participation Trophy',slot:'Relic',rarity:'Uncommon',stat:'maxHp',value:20},
 {id:'spreadsheet',name:'Spreadsheet of Doom',slot:'Relic',rarity:'Rare',stat:'attack',value:8},
 {id:'parlays',name:'Parlays of Power',slot:'Relic',rarity:'Epic',stat:'attack',value:10},
 {id:'bracket',name:'Sacred Bracket',slot:'Relic',rarity:'Epic',stat:'maxHp',value:40},
 {id:'rulebook',name:'The Commissioner’s Rulebook',slot:'Relic',rarity:'Legendary',stat:'defense',value:13},
 {id:'glory',name:'Frozen Moment of Glory',slot:'Relic',rarity:'Legendary',stat:'speed',value:0.24},
 {id:'trade',name:'The Trade That Broke the League',slot:'Relic',rarity:'Mythic',stat:'attack',value:26},
 {id:'badbeat',name:'Relic of the Bad Beat',slot:'Relic',rarity:'Cursed',stat:'attack',value:14,curse:'Enemy attack +8%'},
];
