...
export interface Item { id:string; name:string; slot:'Weapon'|'Helmet'|'Armor'|'Boots'|'Trinket'|'Relic'; rarity:'Common'|'Uncommon'|'Rare'|'Epic'|'Legendary'|'Mythic'|'Cursed'; stat:'attack'|'defense'|'maxHp'|'speed'; value:number; curse?:string }
